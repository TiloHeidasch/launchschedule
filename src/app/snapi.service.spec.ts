...
describe("SnapiService", () => {
  ...
  describe("Articles", () => {
    it("should call getFirstArticles", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://cors.th105.de/https://api.spaceflightnewsapi.net/v4/articles?limit=24&offset=0"
      );
  ...
  describe("Blogs", () => {
    it("should call getFirstBlogs", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://cors.th105.de/https://api.spaceflightnewsapi.net/v4/blogs?limit=24&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
  });
  describe("Reports", () => {
    it("should call getFirstReports", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://cors.th105.de/https://api.spaceflightnewsapi.net/v4/reports?limit=24&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
  });
