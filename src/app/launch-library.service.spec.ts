...
describe("LaunchLibraryService", () => {
  ...
  describe("Agency", () => {
    it("calls getAgencyById", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/agencies/225?mode=detailed"
      );
    ...
    it("calls getFirstAgencies", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/agencies/?mode=detailed&limit=13&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    it("calls getFirstAgencies with search", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/agencies/?mode=detailed&limit=13&search=search&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    it("calls getFirstAgencies with search and featured", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/agencies/?mode=detailed&limit=13&search=search&featured=true&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstAgencies with search and not featured and type", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/agencies/?mode=detailed&limit=13&search=search&agency_type=type&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    it("calls getFirstAgencies with search and featured and type", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/agencies/?mode=detailed&limit=13&search=search&featured=true&agency_type=type&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    it("calls getFirstAgencies with search and not featured and type and countryCode", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/agencies/?mode=detailed&limit=13&search=search&agency_type=type&country_code=countryCode&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    it("calls getFirstAgencies with search and featured and type and countryCode", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/agencies/?mode=detailed&limit=13&search=search&featured=true&agency_type=type&country_code=countryCode&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
  });
  describe("Astronaut", () => {
    it("calls getAstronautById", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/astronaut/123?mode=detailed"
      );
      expect(res.request.method).toBe("GET");
    });
    it("calls getFirstAstronauts", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/astronaut/?limit=20&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
    it("calls getFirstAstronauts with search", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/astronaut/?limit=20&search=search&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
    it("calls getFirstAstronauts with search and status", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/astronaut/?limit=20&search=search&status=1&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
  });
  describe("Event", () => {
    it("calls getEventById", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/event/123"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstEvents", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/event/?limit=10&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstEvents with search", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/event/?limit=10&search=search&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstEvents with search and type", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/event/?limit=10&search=search&type=1&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstEvents with search and type and upcoming", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/event/upcoming/?limit=10&search=search&type=1&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstEvents with search and type and previous", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/event/previous/?limit=10&search=search&type=1&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
  ...
  describe("Launch", () => {
    it("calls getLaunchById", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/launch/123"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstLaunches", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/launch/?limit=10&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstLaunches with search", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/launch/?limit=10&search=search&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstLaunches with search and startDate", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/launch/?limit=10&search=search&net__gte=2020-1-1&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    it("calls getFirstLaunches with search and startDate and endDate", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/launch/?limit=10&search=search&net__gte=2020-1-1&net__lte=2020-1-1&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    it("calls getFirstLaunches with search and startDate and endDate and upcoming", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/launch/upcoming/?limit=10&search=search&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    it("calls getFirstLaunches with search and startDate and endDate and previous", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/launch/previous/?limit=10&search=search&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
  ...
  describe("Location", () => {
    it("calls getLocationById", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/location/123"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstLocations", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/location/?limit=10&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstLocations with search", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/location/?limit=10&search=search&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstLocations with search and countryCode", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/location/?limit=10&search=search&country_code=countryCode&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
  });
  describe("Pad", () => {
    it("calls getPadById", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/pad/123"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstPads", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/pad/?limit=10&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstPads with search", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/pad/?limit=10&search=search&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
  });
  describe("Rocket", () => {
    it("calls getRocketById", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/config/launcher/123"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstRockets", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/config/launcher/?limit=10&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstRockets with search", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/config/launcher/?limit=10&search=search&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstRockets with search and ACTIVE", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/config/launcher/?limit=10&search=search&active=true&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstRockets with search and DECOMISSIONED", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/config/launcher/?limit=10&search=search&active=false&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstRockets with search and ALL and EXPENDABLE", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/config/launcher/?limit=10&search=search&reusable=false&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstRockets with search and ALL and REUSABLE", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/config/launcher/?limit=10&search=search&reusable=true&offset=0"
      );
      expect(res.request.method).toBe("GET");
    });
  });
  describe("Spacecraft", () => {
    it("calls getSpacecraftById", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/config/spacecraft/123"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstSpacecrafts", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/config/spacecraft/?limit=10&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstSpacecrafts with search", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/config/spacecraft/?limit=10&search=search&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstSpacecrafts with search and ACTIVE", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/config/spacecraft/?limit=10&search=search&in_use=true&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstSpacecrafts with search and DECOMISSIONED", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/config/spacecraft/?limit=10&search=search&in_use=false&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstSpacecrafts with search and ALL and CARGO", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/config/spacecraft/?limit=10&search=search&human_rated=false&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstSpacecrafts with search and ALL and HUMAN", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/config/spacecraft/?limit=10&search=search&human_rated=true&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
  });
  describe("Spacestation", () => {
    it("calls getSpacestationById", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/spacestation/123"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstSpacestations", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/spacestation/?limit=10&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstSpacestations with search", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/spacestation/?limit=10&search=search&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstSpacestations with search and status", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/spacestation/?limit=10&search=search&status=1&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstSpacestations with search and status and orbit", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/spacestation/?limit=10&search=search&status=1&orbit=2&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
    ...
    it("calls getFirstSpacestations with search and status and orbit and type", () => {
      ...
      const res = httpTestingController.expectOne(
        "https://lldev.thespacedevs.com/2.0.0/spacestation/?limit=10&search=search&status=1&orbit=2&type=3&offset=0&ordering=name"
      );
      expect(res.request.method).toBe("GET");
    });
  });
