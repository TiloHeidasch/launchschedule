...
export class LaunchLibraryService {
  ...
  async getAgencyById(id: string, bypassCache?: boolean) {
    ...
    const url = this.baseUrl + "/agencies/" + id + "?mode=detailed";
  ...
  private createAgencyUrl(
    ...
    let url = this.baseUrl + "/agencies/?mode=detailed";
    url += "&limit=" + limit;
  ...
  async getAstronautById(id: string, bypassCache?: boolean) {
    ...
    const url = this.baseUrl + "/astronaut/" + id + "?mode=detailed";
    const data = await this.http.get<any>(url).toPromise();
  ...
  private createAstronautUrl(
    ...
    let url = this.baseUrl + "/astronaut/";
    url += "?limit=" + limit;
    if (search !== undefined && search !== "") {
      url += "&search=" + search;
    }
  ...
  private createRocketUrl(
    ...
    let url = this.baseUrl + "/config/launcher/";
    url += "?limit=" + limit;
    if (search !== undefined && search !== "") {
      url += "&search=" + search;
    }
  ...
  async getSpacecraftById(id: string, bypassCache?: boolean) {
    ...
    const url = this.baseUrl + "/config/spacecraft/" + id;
    const data = await this.http.get<any>(url).toPromise();
  ...
  private createSpacecraftUrl(
    ...
    let url = this.baseUrl + "/config/spacecraft/";
    url += "?limit=" + limit;
    if (search !== undefined && search !== "") {
      url += "&search=" + search;
    }
  ...
  async getSpacestationById(id: string, bypassCache?: boolean) {
    ...
    const url = this.baseUrl + "/spacestation/" + id;
    const data = await this.http.get<any>(url).toPromise();
  ...
  private createSpacestationUrl(
    ...
    let url = this.baseUrl + "/spacestation/";
    url += "?limit=" + limit;
    if (search !== undefined && search !== "") {
      url += "&search=" + search;
    }
